...
/*				if (fecdesde<fecretiro) {
	...
	if (ok) {
		...
		if (dias>90) {
				ok = false;			
				errores += "- Fecha Desde: No se puede consultar Trámites con más de 90 días.\n";										
		};		
		var dias = DifFechas(fechasta,fecdesde);
		if (dias>31) {
				ok = false;			
				errores += "- La Diferencia entre Fecha Desde y Hasta no puede superar los 31 días.\n";										
...
<table align="center" width="420">
	<tr><td class="celdatexto" width="30%" align="right" nowrap>Fecha de Rétiro Desde:</td>
	...
	<tr><td class="celdatexto" align="right" nowrap>Fecha de Rétiro Hasta:</td>
