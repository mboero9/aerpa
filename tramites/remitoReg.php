...
//			  document.frm.id_remito.value=results[3];
			  ...
			  document.descarga.propiedadesreport1.value ="ReportHeader|1|Región:\n"+														  			  			  
...
//			  document.descarga.submit();
			  ...
			  if (results[0]=='sintramites') {
				  document.getElementById('spanREMITO').innerHTML=(document.frm.par_registro.value=='origen' ? 'No Existen Trámites Pendientes para Devolver a Origen' : 'No Existen Trámites Pendientes');			
			  }else{
alert(results);			  
