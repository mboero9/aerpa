...
<tr>
<th align="center" class="celdatitulo" colspan="3">Ingrese el número de Voucher a Imprimir:</th>
</tr>
<tr>
...
/*		$Sql="SELECT     T.TRA_NRO_VOUCHER, T.TRA_DOMINIO,"
		...
		{
		    $mensaje='El Nro de Voucher no se encuentra disponible para impresión.';			
		}//Cierro else
		if ($mensaje!="") {				
		?>
	...
	catch(exception $e)
	{
		...
		<table align="center" width="40%" class="tablaconbordes">
		<tr>
		<td align="center" class="textoerror">Error al realizar la operación.</td>
		</tr>
		</table>
		<?
	}
